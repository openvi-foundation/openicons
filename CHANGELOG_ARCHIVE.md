...
This is the PrimeIcons changelog, up to and including the final 7.0.0 release, preserved
verbatim. Issue and release links point at `primefaces/primeicons`, which is where that
history actually lives.

For changes since the fork, see [CHANGELOG.md](CHANGELOG.md).
